!function (window) {
  ...
  function h(a, b, c) {
    this.initialize = function () {
      ...
      return "horizontal" == this.direction
        ? (this.nodeA.cx > this.nodeZ.cx && (i = -i), d.push({x: b.x, y: b.y + h}), d.push({x: b.x + i, y: b.y + h}), d.push({x: c.x - i, y: c.y + h}), d.push({
        x: c.x,
        y: c.y + h
      }))
  ...
  function r(a, b, c) {
    ...
    p(b, d)
    if (1 == c) for (var e = 0; e < d.length; e++) r(a, d[e], c);
    return null
  }
  ...
  // BarChartNode, PieChartNode 的具体实现
  function (a) {
  function b() {
